...
variable_queries = [
    ...
    ({"v": "ML_price", "category": ["hov3", "hov2"], "time_period": ["7:00", "9:00"]},1),
]
...
def test_query_roadway_property_by_time_group(
    ...
    _selected_links = net.get_selection(project_card.roadway_managed_lanes["facility"]).selected_links
...
def test_identify_segment_ends(request, stpaul_net):
    ...
    correct_d = {0: [4799, 68320], 1: [45635, 106816], 2: [35752, 66416], 3: [32501, 62153], 4: [7734, 77606], 5: [7715, 61777], 6: [12163, 39514], 7: [100805, 161661], 8: [122991, 123042], 9: [57530, 118107], 10: [35752, 44233], 11: [44190, 123002], 12: [47478, 47522], 13: [47478, 49757], 14: [57601, 57637], 15: [60956, 106816], 16: [66415, 123049], 17: [71838, 134504], 18: [75313, 134918], 19: [78880, 78885]}
