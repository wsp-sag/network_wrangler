...
def test_convert_stops_to_wrangler_stops():
    ...
    pd.testing.assert_frame_equal(out_stops_df.sort_index(axis=1), expected_stops_df.sort_index(axis=1))
...
def test_convert_stop_times_to_wrangler_stop_times():
    ...
    pd.testing.assert_frame_equal(out_stop_times_df.sort_index(axis=1), expected_stop_times_df.sort_index(axis=1))
